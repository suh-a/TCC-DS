...
// ======== SONS ========
const somClick = new Audio('sons/click.wav');
const somAcerto = new Audio('sons/acerto.wav');
const somError = new Audio('sons/error.wav');
const somGamecompleted = new Audio('sons/gamecompleted.wav');
const somGameover = new Audio('sons/gameover.wav');
