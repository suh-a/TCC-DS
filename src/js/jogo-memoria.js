...
// ======== SONS ========
const somClick = new Audio('/src/assets/audio/click.wav');
const somAcerto = new Audio('/src/assets/audio/acerto.wav');
const somError = new Audio('/src/assets/audio/error.wav');
const somGamecompleted = new Audio('/src/assets/audio/gamecompleted.wav');
const somGameover = new Audio('/src/assets/audio/gameover.wav');
...
function gerarCartas(qtdPares) {
  ...
  carta.innerHTML = `
    <div class="carta-inner">
      ...
      <div class="carta-frente"><img src="/src/assets/img/${nome}.jpg" alt="${nome}"></div>
    </div>
  `;
